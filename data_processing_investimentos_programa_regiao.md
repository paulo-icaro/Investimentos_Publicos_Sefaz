# Processamento de Dados - Investimentos Públicos por Programa e Região
...
No campo Código, os investimentos estão classificados em Programa e
Região. Assim cabe ao pesquisador definir como ele deseja o resultado
...
processado[^1]. Esse procedimento se replica nos três casos possíveis,
...
segunda parte diz respeito a regra de acumulação das informações. **Cada
planilha que passa pelo procedimento rerpresenta um dataset que
contribui para um dataframe final chamado dataset_full contendo todas as
informações por ano, mês e tipo de investimento e função**.
</p>

[^1]: A padronização dos nomes dos arquivos é ponto crucial na distinção
