---
title: "Processamento de Dados - Investimentos Públicos por Função"
format:
  gfm: default
  pdf:
    pdf-engine: pdflatex
...
|       Levando em conta os pontos mencionados e que os dados são cumulativos, o objetivo dessa rotina é coletar as informações referente a Função considerando somente os valores de investimentos Empenhado e Pago.
