...
      Este repositório contém as rotinas responsáveis por realizar os
...
período 2013-2015 não disponibilizar as informações por região. Para a
...
[^1]: Obviamente, para o mês de janeiro não é necessário realizar nenhum
